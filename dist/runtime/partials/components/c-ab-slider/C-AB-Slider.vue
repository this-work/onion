...
const properties = defineProps({
  ...
  bounds: { type: Number, required: false, default: 0 },
  initialPosition: { type: Number, required: false, default: 50 },
  keyboardIncrement: { type: Number, required: false, default: 5 },
