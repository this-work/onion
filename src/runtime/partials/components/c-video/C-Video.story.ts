...
export const VideoWithPosterAndAspectRatio: Story = {
  args: {
    src: 'https://storage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    borderRadius: 'm',
...
export const VideoWithAutoplayAndAlternateSources: Story = {
  args: {
    srcAlternates: {
      default: {
...
export const VideoWithTracks: Story = {
  args: {
