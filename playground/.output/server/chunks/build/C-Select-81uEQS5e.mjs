...
import { _ as __nuxt_component_1 } from './index-B5dIXVXz.mjs';
import { createElementBlock, openBlock, withKeys, normalizeClass, withModifiers, renderSlot, createElementVNode, createBlock, createVNode, createCommentVNode, withDirectives, Fragment, renderList, toDisplayString, vShow, Transition, withCtx, normalizeStyle, createTextVNode, Teleport, defineComponent, computed, ref, watch, mergeProps, unref, useSlots, useSSRContext } from 'vue';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(script), {
        ...
        caret: withCtx((scopedSlot, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass(unref(useBem)("caret"))}"${_scopeId}>`);
        ...
        noResult: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "noResult", {}, () => {
              _push2(` `);
        ...
        noOptions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        maxElements: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../src/runtime/partials/components/c-select/C-Select.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_8 = Object.assign(_sfc_main, { __name: "CSelect" });

export { __nuxt_component_8 as default };
//# sourceMappingURL=C-Select-81uEQS5e.mjs.map
