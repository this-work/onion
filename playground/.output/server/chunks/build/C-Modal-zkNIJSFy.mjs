  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isOpen)) {
          _push2(`<aside class="${ssrRenderClass(partialClass.value)}" style="${ssrRenderStyle({
            background: unref(level) === 0 ? "rgba(0, 0, 0, 0.8)" : "rgba(0, 0, 0, 0.25)",
            zIndex: 900 + unref(level) * 10
          })}"><div class="${ssrRenderClass(unref(useBem)("container"))}" style="${ssrRenderStyle(isSimpleLayer.value ? { width: `${_ctx.width}px` } : {})}"><div role="dialog" aria-modal="true"${ssrRenderAttr("aria-describedby", contentID)} class="${ssrRenderClass(unref(useBem)("box"))}"><div class="${ssrRenderClass(unref(useBem)("controls"))}">`);
...
//# sourceMappingURL=C-Modal-zkNIJSFy.mjs.map
