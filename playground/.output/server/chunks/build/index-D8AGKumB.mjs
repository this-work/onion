...
import __nuxt_component_6 from './C-Input-DeVkNulK.mjs';
import __nuxt_component_7 from './C-Switch-CNCiChAK.mjs';
import __nuxt_component_8 from './C-Select-81uEQS5e.mjs';
import __nuxt_component_9 from './C-Textarea-B-7jv4WG.mjs';
import __nuxt_component_1$1 from './C-Button-BYIrkxZH.mjs';
import __nuxt_component_1$2 from './C-Image-BlpE6N20.mjs';
import __nuxt_component_1$3 from './C-Modal-zkNIJSFy.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Slot, { width: 6 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`</div>`);
                        _push4(ssrRenderComponent(_component_C_Headline, {
                          headline: "Prop Reactivity Test (C-Input)",
                          "headline-type": "h5",
                          "headline-tag": "h3",
                          style: { "margin-top": "var(--spacing-xl)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Text, { text: "Testing C-Input value prop reactivity - the input should update when prop changes:" }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Input, {
                          type: "number",
                          name: "test-input",
                          label: "Controlled Input (external value)",
                          value: inputValue.value,
                          onChange: (val) => inputValue.value = val,
                          style: { "margin-top": "var(--spacing-m)" }
                        }, null, _parent4, _scopeId3));
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "var(--spacing-s)", "margin-top": "var(--spacing-s)" })}"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Set to 10",
                          onClick: ($event) => inputValue.value = "10"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Set to 25",
                          onClick: ($event) => inputValue.value = "25"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Set to 100",
                          onClick: ($event) => inputValue.value = "100"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Increment",
                          onClick: ($event) => inputValue.value = String(Number(inputValue.value || 0) + 1)
                        }, null, _parent4, _scopeId3));
                        _push4(`</div>`);
                        _push4(ssrRenderComponent(_component_C_Text, {
                          text: `Current value: ${inputValue.value || "(empty)"}`,
                          style: { "margin-top": "var(--spacing-s)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Headline, {
                          headline: "Prop Reactivity Test (C-Switch)",
                          "headline-type": "h5",
                          "headline-tag": "h3",
                          style: { "margin-top": "var(--spacing-l)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Text, { text: "Testing C-Switch checked prop reactivity - the switch should update when prop changes:" }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Switch, {
                          label: "Controlled Switch (external state)",
                          name: "test-switch",
                          checked: switchValue.value,
                          onChange: (val) => switchValue.value = val,
                          style: { "margin-top": "var(--spacing-m)" }
                        }, null, _parent4, _scopeId3));
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "var(--spacing-s)", "margin-top": "var(--spacing-s)" })}"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Set to ON",
                          onClick: ($event) => switchValue.value = true
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Set to OFF",
                          onClick: ($event) => switchValue.value = false
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Button, {
                          appearance: "secondary",
                          text: "Toggle",
                          onClick: ($event) => switchValue.value = !switchValue.value
                        }, null, _parent4, _scopeId3));
                        _push4(`</div>`);
                        _push4(ssrRenderComponent(_component_C_Text, {
                          text: `Current state: ${switchValue.value ? "ON" : "OFF"}`,
                          style: { "margin-top": "var(--spacing-s)" }
                        }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          ...
                          createVNode(_component_C_Text, { text: "Testing C-Input value prop reactivity - the input should update when prop changes:" }),
                          createVNode(_component_C_Input, {
                            type: "number",
                            name: "test-input",
                            label: "Controlled Input (external value)",
                          ...
                          createVNode("div", { style: { "display": "flex", "gap": "var(--spacing-s)", "margin-top": "var(--spacing-s)" } }, [
                            createVNode(_component_C_Button, {
                              appearance: "secondary",
                              text: "Set to 10",
                              onClick: ($event) => inputValue.value = "10"
                          ...
                          createVNode(_component_C_Text, { text: "Testing C-Switch checked prop reactivity - the switch should update when prop changes:" }),
                          createVNode(_component_C_Switch, {
                            label: "Controlled Switch (external state)",
                            name: "test-switch",
                            checked: switchValue.value,
                  ...
                  _push3(ssrRenderComponent(_component_Slot, { width: 6 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_C_Headline, {
                          headline: "Image Examples",
                          "headline-type": "h5",
                          "headline-tag": "h3",
                          style: { "margin-bottom": "var(--spacing-m)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Text, {
                          text: "Original C-Image implementation:",
                          style: { "margin-bottom": "var(--spacing-s)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Image, {
                          src: "/test-image.png",
                          "border-radius": "m",
                          alt: "Original image implementation",
                          description: "Traditional picture element with manual source sets",
                          style: { "margin-bottom": "var(--spacing-l)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Text, {
                          text: "Nuxt Picture integration (optimized):",
                          style: { "margin-bottom": "var(--spacing-s)" }
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(_component_C_Image, {
                          "use-nuxt-picture": true,
                          src: "/test-image.png",
                          format: "webp,avif",
                          quality: 90,
                          sizes: "sm:100vw md:50vw lg:600px",
                          "border-radius": "m",
                          alt: "Nuxt Picture optimized image",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_C_Headline, {
              headline: "Small Modal with Select",
              "headline-type": "h5",
              style: { "margin-bottom": "var(--spacing-m)" }
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_C_Text, {
              text: "This modal contains a select with many items to test z-index layering.",
              style: { "margin-bottom": "var(--spacing-m)" }
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_C_Text, { text: "Additional content below the select to test if the dropdown overlays correctly." }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { style: { "padding": "var(--spacing-m)", "max-width": "500px" } }, [
                ...
                createVNode(_component_C_Text, { text: "Additional content below the select to test if the dropdown overlays correctly." })
              ])
            ];
          }
        }),
...
//# sourceMappingURL=index-D8AGKumB.mjs.map
